...
const tours: ITour[] = [
  {
    id: "1",
    title: "Музей-усадьба",
    description: "Музей усадьбы представляет собой уникальное собрание экспонатов, связанных с жизнью и творчеством Александра Пушкина и его семьи. Здесь вы сможете погрузиться в атмосферу той эпохи и узнать больше о быте дворянского рода.",
    img: museum
  },
  {
    id: "2",
